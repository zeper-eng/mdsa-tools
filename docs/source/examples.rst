...
.. grid:: 3 3 3 3 
   ...
   .. grid-item-card::
      :shadow: lg
      :link-type: doc
      :link: examples/hbond_replicate_maps
      :text-align: center

      **Hbond Replicate Maps**

      ^^^
      .. image:: ../resources/Hbond_Replicate_Map.png
         :alt: Filler card 8
         :width: 100%
         :align: center
   ...
   .. grid-item-card::
      :shadow: lg
      :link-type: doc
      :link: examples/umap_example
      :text-align: center

      **UMAP embedding visualization example**

      ^^^
      .. image:: ../resources/UMAP-img.png
         :alt: Filler card 9
         :width: 100%
         :align: center
