...
list_of_frames = labels_to_frames(persys_frame_list,CGU_opt_labels)

import msmhelper as mh

# Implied timescales over a range of lag times
its = mh.msm.implied_timescales(list_of_frames, lagtimes=[1, 2, 5, 10, 15, 20, 25,30,35,40,45,50,55,60], ntimescales=1)
print(f"its:{its}")
...
np.savetxt('CGU_Transition_Probability_Matrix_T_45.csv',T_45,delimiter=',')
np.savetxt('CGU_Transition_Probability_Matrix_T_1.csv',T_1,delimiter=',')
