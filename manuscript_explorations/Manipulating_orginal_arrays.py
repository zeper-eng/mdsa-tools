...
PC1_ordered_weights=PCA_ranked_weights.sort_values('PC1_magnitude',ascending=False).head(20)
PC2_ordered_weights=PCA_ranked_weights.sort_values('PC2_magnitude',ascending=False).head(20)
PC1_ordered_weights.to_csv('PC1_ordered_weights.csv',index=False)
PC2_ordered_weights.to_csv('PC2_ordered_weights.csv',index=False)
os._exit(0)
